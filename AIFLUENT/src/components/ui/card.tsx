...
const cardVariants = cva(
  'rounded-xl border border-slate-700/50 bg-slate-800/50 backdrop-blur-sm text-slate-100',
  {
    variants: {
      variant: {
        default: '',
        elevated:
          'shadow-xl shadow-black/20 border-white/5 bg-gradient-to-b from-slate-800/80 to-slate-900/80',
        interactive:
