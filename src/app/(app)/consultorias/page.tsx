  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-8 space-y-6">
        ...
        {/* Filters */}
        <div className="flex items-center gap-4 bg-white border border-[var(--border)] rounded-xl px-5 py-3">
          <span className="text-xs font-semibold text-[var(--text3)] uppercase tracking-wider">Filtrar:</span>
        ...
        {loading ? (
          ...
          <div className="bg-white border border-[var(--border)] rounded-xl p-12 text-center">
            ...
            <p className="text-[var(--text3)] text-sm mt-1">Inicie uma consultoria pelo menu lateral</p>
          </div>
        ) : (
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[var(--border)]">
                    ...
                    <th className="text-left py-3 px-4 text-[10px] font-semibold uppercase tracking-wider text-[var(--text3)]">Termino</th>
                ...
                <tbody>
                  {filtered.map((s) => (
                    <tr key={s.id} className="border-b border-[var(--border)] hover:bg-[var(--bg)] transition-colors">
                      ...
                      <td className="py-3 px-4 text-[var(--text2)]">{formatDate(s.endDate)}</td>
                      <td className="py-3 px-4">
                      ...
                      <td className="py-3 px-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <Link
                            href={`/consultorias/${s.id}/relatorio`}
